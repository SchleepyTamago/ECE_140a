...
str1 = "Mary had a little lamb, little lamb, little lamb!"
print(str1.find("little")) # 11
print(str1[11:]) # prints ‘little lamb, little lamb, little lamb!'
